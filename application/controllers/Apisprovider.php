...
class Apisprovider extends CI_Controller
{
    ...
    //-----------------------------------------------//
  		...
  		public function version_check()
  		{
  			...
  			$data['result']=$this->apisprovidermodel->version_check($version_code);
...
//-----------------------------------------------//
    ...
    public function re_upload_doc()
    {
        ...
        $data['result'] = $this->apisprovidermodel->re_upload_doc($user_master_id, $doc_master_id, $doc_proof_number, $documentFileName,$doc_detail_id);
        $response       = $data['result'];
        echo json_encode($response);
    }
    ...
    //-----------------------------------------------//
        ...
        public function list_service_bills()
    	{
    		...
    		$data['result']=$this->apisprovidermodel->List_service_bills($user_master_id,$service_order_id);
    		$response = $data['result'];
    		echo json_encode($response);
    	}
    ...
    //-----------------------------------------------//
    	...
    	public function list_reason_for_cancel()
    	{
    		...
    		$user_master_id  = $this->input->post("user_master_id");
    		$data['result']=$this->apisprovidermodel->list_reason_for_cancel($user_master_id);
    		$response = $data['result'];
    		echo json_encode($response);
    	}
