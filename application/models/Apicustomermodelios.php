...
class Apicustomermodelios extends CI_Model
{
    ...
    function Login($user_master_id, $phone_no, $otp, $device_token, $mobiletype, $unique_number, $referral_code)
    {
        ...
        if ($sql_result->num_rows() > 0)
        {
            ...
            $update_unique_number_result = $this
                ->db
                ->query($update_unique_number);
    ...
    function add_referral_code($user_master_id, $referral_code)
    {
        if ($referral_code == 'SKILEX100')
        {
            ...
            if ($referral_status == '0')
            {
                ...
                $res_adding_history = $this
                    ->db
                    ->query($adding_history);
                ...
                $re_query_user_master = $this
                    ->db
                    ->query($query_user_master);
        ...
        else
        {
            ...
            if ($re_referral->num_rows() != 0)
            {
                ...
                if ($referral_status == '0')
                {
                    ...
                    $re_referral_master = $this
                        ->db
                        ->query($check_referral_master);
    ...
    function user_lang_update($user_master_id, $lang_id)
    {
        ...
        if ($res)
        {
            $response = array(
                "status" => "success",
                "msg_en" => "Language update successfully",
                "msg_ta" => "Language Update successfully"
            );
        }
        else
        {
    ...
    function check_to_claim_points($user_master_id)
    {
        ...
        if ($re_select->num_rows() == 0)
        {
            $response = array(
                "status" => "error",
                "msg" => "You cannot claim amount is low",
                "msg_en" => "",
                "msg_ta" => "உங்கள் புள்ளி குறைவாக உள்ளது. எனவே நீங்கள் உரிமை கோர முடியாது"
            );
        }
        else
        {
            ...
            else
            {
                $response = array(
                    "status" => "error",
                    "msg" => "You cannot claim point is low",
                    "msg_en" => "",
                    "msg_ta" => "உங்கள் புள்ளி குறைவாக உள்ளது. எனவே நீங்கள் உரிமை கோர முடியாது"
                );
            }
        ...
        else
        {
            ...
            if ($user_points_to_claim >= $minimum_points)
            {
                ...
                if ($ex_wallet_history)
                {
                    $response = array(
                        "status" => "success",
                        "msg_en" => "Amount added in wallet",
                        "msg_ta" => "Amount added in wallet",
                        "msg" => "Amount added in wallet!"
                    );
                }
                else
                {
    ...
    function check_wallet_balance_and_history($user_master_id)
    {
        ...
        $re_wallet_history = $this
            ->db
            ->query($query_wallet_history);
        if ($re_wallet_history->num_rows() == 0)
        {
            $res_wallet = array(
                "status" => "error",
                "msg_en" => "no history found",
                "msg_ta" => "no history found",
                "msg" => "error"
            );
        }
        else
        {
            ...
            $res_wallet = array(
                "status" => "success",
                "msg_en" => "wallet history found",
                "msg_ta" => "wallet history found",
...
left join customer_details as cd on cd.user_master_id=sr.customer_id WHERE so.service_id='$service_id' order by sr.created_at desc";
        ...
        if ($res->num_rows() > 0)
        {
            ...
            $response = array(
                "status" => "success",
                "msg" => "View Services reviews and rating",
                "services_reviews" => $ser_data,
                "msg_en" => "",
                "msg_ta" => ""
            );
        ...
        else
        {
            $response = array(
                "status" => "error",
                "msg" => "No reviews and rating found!",
                "msg_en" => "No reviews and rating found!",
                "msg_ta" => "சேவைகள் கிடைக்கவில்லை!"
            );
        }
    ...
    function View_maincategory($user_master_id, $version_code)
    {
        if (empty($version_code))
        {
            $response = array(
                "status" => "error",
                "msg" => "Sorry you have to update latest App!",
                "msg_en" => "Sorry you have to update latest App!",
                "msg_ta" => "பிரிவுகள் கிடைக்கவில்லை!"
            );
    ...
    function View_subcategory($main_cat_id)
    {
        ...
        else
        {
            $response = array(
                ...
                "msg_en" => "Sub-categories not found!",
                "msg_ta" => "துணைப்பிரிவுகள் கிடைக்கவில்லை!"
            );
        }
    ...
    function add_service_to_cart($user_master_id, $category_id, $sub_category_id, $service_id)
    {
        ...
        else
        {
            $response = array(
                ...
                "msg_en" => "Already added to cart",
                "msg_ta" => "கார்ட்டில் சேர்க்கப்பட்டுவிட்டது!"
            );
        }
    ...
    function remove_service_to_cart($cart_id)
    {
        ...
        if ($query_result)
        {
            $response = array(
                ...
                "msg_en" => "Service removed from cart",
                "msg_ta" => "சேவை கார்ட்டிலிருந்து நீக்கப்பட்டது "
            );
        }
        else
        {
    ...
    function clear_cart($user_master_id)
    {
        ...
        if ($query_result)
        {
            $response = array(
                "status" => "success",
                "msg" => "All Service removed from cart",
                "msg_en" => "",
                "msg_ta" => ""
            );
        }
    ...
    WHERE oc.user_master_id='$user_master_id' AND oc.status='Pending' order by s.advance_amount desc";
        ...
        else if ($result_no > 1)
        {
            ...
            for ($i = 1;$i < $last_cnt;$i++)
            {
                ...
                $res_add_service = $this
                    ->db
                    ->query($insert_add_service);
            ...
            for ($i = 1;$i <= $cnt;$i++)
            {
                ...
                if ($result->num_rows() == 1)
                {
                    ...
                    else
                    {
                        ...
                        $result_last_sp_id = $this
                            ->db
                            ->query($get_last_service_provider_id);
                  ...
                  GROUP by spps.user_master_id order by spps.id asc LIMIT 1";
                            ...
                            $res_order_history = $this
                                ->db
                                ->query($check_order_history);
                            ...
                            if ($res_order_history->num_rows() == 0)
                            {
                                ...
                                $res_quest = $this
                                    ->db
                                    ->query($request_insert_query);
                                if ($res_quest)
                                {
                                    $response = array(
                                        "status" => "success",
                                        "msg" => "Waiting for Service Provider to Accept",
                                        "msg_en" => "",
                                        "msg_ta" => ""
                                    );
                                }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                $ex_checking_order_hist = $this
                                    ->db
                                    ->query($checking_order_hist);
                  ...
                  WHERE spps.main_cat_id='$selected_main_cat_id' AND spps.status='Active' AND vs.online_status='Online' AND lu.status='Active' GROUP by spd.id";
                            ...
                            $res_chec_provider = $this
                                ->db
                                ->query($check_provider);
    ...
    function service_pending_and_offers_list($user_master_id)
    {
        ...
        $response = array(
            "status" => "success",
            "msg" => "Service and offer list",
            "offer_response" => $offer_list,
            "msg_en" => "",
            "msg_ta" => ""
        );
 ...
 WHERE so.id='$service_order_id'";
    ...
    function service_order_bills($user_master_id, $service_order_id)
    {
        ...
        if ($res_offer->num_rows() == 0)
        {
            $response = array(
                "status" => "error",
                "msg" => "No  Bills found",
                "msg_en" => "Bills unavailable!",
                "msg_ta" => "ரசிதுகள் கிடைக்கவில்லை!"
            );
        }
        else
        {
    ...
    function view_addtional_service($user_master_id, $service_order_id)
    {
        ...
        if ($res_offer->num_rows() == 0)
        {
            $response = array(
                "status" => "error",
                "msg" => "No Service found",
                "msg_en" => "No Service found",
                "msg_ta" => "No Service found"
            );
        }
        else
        {
    ...
    function service_coupon_list($user_master_id)
    {
        ...
        if ($res_offer->num_rows() == 0)
        {
            $response = array(
                "status" => "error",
                "msg" => "No Offers found",
                "msg_en" => "Offers unavailable!",
                "msg_ta" => "சலுகைகள் கிடைக்கவில்லை!"
            );
        }
        else
        {
            ...
            if ($res_query_copun->num_rows() == 1)
            {
                ...
                if ($total >= $minimu_purchase_amt)
                {
                    ...
                    if ($update_result)
                    {
                        $response = array(
                            "status" => "success",
                            "msg" => "You saved $rows_coupon->offer_percent",
                            "msg_en" => "",
                            "msg_ta" => ""
                        );
                    }
                ...
                else
                {
                    $response = array(
                        "status" => "error",
                        "msg" => "You have minimum amount coupon cannot applicable",
                        "msg_en" => "You have minimum amount coupon cannot applicable!",
                        "msg_ta" => "தவறான குறியீடு!"
                    );
                }
            }
            else
    ...
    function uncheck_from_wallet($user_master_id, $service_order_id)
    {
        ...
        else
        {
            ...
            if ($res)
            {
                $response = array(
                    "status" => "success",
                    "msg" => "Amount back to wallet",
                    "msg_ta" => "Amount back to wallet",
                    "msg_en" => "Amount back to wallet"
                );
            }
            else
            {
    ...
    function Service_reviewslist($service_order_id)
    {
        ...
        if ($res->num_rows() > 0)
        {
            ...
            $response = array(
                "status" => "success",
                "msg" => "View Reviews List",
                "services_reviewlist" => $review_list,
                "msg_en" => "",
                "msg_ta" => ""
            );
        }
        else
        {
            $response = array(
                "status" => "error",
                "msg" => "Service order Reviews not found",
                "msg_en" => "",
                "msg_ta" => ""
            );
        }
    ...
    function automatic_provider_allocation()
    {
        ...
        else
        {
            ...
            foreach ($result as $rows_order)
            {
                ...
                $ex_last_provider_id = $this
                    ->db
                    ->query($get_last_provider_id);
            ...
            where lu.status='Active' and vs.online_status='Online' and lu.user_type=3 and lu.document_verify='Y' and spps.main_cat_id='$main_cat_id'";
               ...
               AND spd.user_master_id<$last_provider_id GROUP BY spps.user_master_id ASC) s_union";
                            ...
                            else
                            {
                                ...
                                $ex_check_exist_history = $this
                                    ->db
                                    ->query($check_exist_history);
    ...
    function customer_address_add($cust_id, $contact_name, $contact_no, $serv_lat_lon, $serv_loc, $serv_address)
    {
		...
		('" . $cust_id . "','" . $contact_name . "','" . $contact_no . "','" . $serv_lat_lon . "','" . $serv_loc . "','" . $serv_address . "',NOW())";
            ...
            $response = array(
                "status" => "success",
                "msg_en" => "Address Added successfully",
                "msg_ta" => "Address Added successfully"
            );
        }
        else
        {
            $response = array(
                "status" => "error",
                "msg_en" => "Already added!",
                "msg_ta" => "Already added"
            );
        }
        return $response;
    }
    ...
    function customer_address_list($cust_id)
    {
        ...
        else
        {
            $response = array(
                "status" => "error",
                "msg_en" => "Address Not found!",
                "msg_ta" => "Address Not found!"
            );
        }
        return $response;
    }
    ...
    function customer_address_edit($address_id, $contact_name, $contact_no, $serv_lat_lon, $serv_loc, $serv_address)
    {
        ...
        $response = array(
            "status" => "success",
            "msg_en" => "Address Updated successfully",
            "msg_ta" => "Address Updated successfully"
        );
        return $response;
    }
    ############### Customer address end ###############
