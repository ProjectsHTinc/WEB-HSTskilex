  ...
  padding: 0px;
        ...
        <div class="content-wrapper">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom">
              ...
              <li class="breadcrumb-item active" aria-current="page"><span>Date between Tax Transaction</span></li>
            </ol>
          </nav>
          <div class="row">
      ...
      <tbody>
        <?php $i=1; foreach($res as $rows){
			$tax_amount = $rows->tax_amount/2;
			?>
          <tr>
                <td><?php echo $i; ?></td>
                <td><?php echo $rows->tot_amount; ?></td>
                <td class="amt"><?php echo $rows->sp_commission; ?></td>
                <td class="amt"><?php echo $rows->sk_commision; ?></td>
                <td class="amt"><?php echo $tax_amount; ?></td>
                <td class="amt"><?php echo $tax_amount; ?></td>
                <td class=""><a href="<?php echo base_url(); ?>transaction/from_date_to_date_tax_list/<?php echo $rows->from_date; ?>/<?php echo $rows->to_date; ?>/" class="btn btn-primary">View</a></td>
          </tr>
        <?php  $i++;  }  ?>
