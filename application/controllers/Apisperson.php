...
class Apisperson extends CI_Controller {
	...
	//-----------------------------------------------//
		...
		public function version_check()
		{
			...
			$data['result']=$this->apispersonmodel->version_check($version_code);
...
//-----------------------------------------------//
	...
	public function view_time_slot()
	{
		...
		$user_master_id  = $this->input->post("user_master_id");
		$data['result']=$this->apispersonmodel->view_time_slot($user_master_id);
		$response = $data['result'];
		echo json_encode($response);
	}
...
//-----------------------------------------------//
	...
	public function list_reason_for_cancel()
	{
		...
		$user_master_id  = $this->input->post("user_master_id");
		$data['result']=$this->apispersonmodel->list_reason_for_cancel($user_master_id);
		$response = $data['result'];
		echo json_encode($response);
	}
