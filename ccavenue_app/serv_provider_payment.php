...
for($i = 0; $i < $dataSize; $i++)
	{
    	...
    	{
            $query = "UPDATE daily_payment_transaction SET skilex_closing_status ='Received', serv_prov_closing_status = 'Paid', order_id = '$orderid', ccavenue_track_id ='$track_id' WHERE id = '$daily_payment_id'";
